...
// Address decode
// =============================
// Declared FIRST — before any instance that uses them
// (Questa errors if a wire is used in a port connection before it is declared)
...
// =============================
// Also declared before cache_inst uses them in port connections
