...
module simple_memory #(parameter ADDR_WIDTH = 8
...
// Memory initialization inside always block (not initial) to avoid
// dual-driver error: always_ff cannot share a variable with an initial block
